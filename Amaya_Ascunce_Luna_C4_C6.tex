...
\begin{tabular}{llll}
  ...
  \midrule
  Luna & Sagitario & Casa 5 & 23°01' \\
  Casa 4 (cúspide) & Escorpio & --- & Regente: Plutón \\
  Casa 6 (cúspide) & Capricornio & --- & Regente: Saturno \\
  Ascendente & Leo & --- & 15°06' \\
  Medio Cielo & Tauro & --- & 4°05' \\
  \bottomrule
\end{tabular}
\end{center}

\vspace{0.4cm}
\textbf{Planetas en Casa 4:} Urano\\
...
\begin{tabular}{lllll}
  ...
  \midrule
  Luna & ✶ & Marte & Sextil & 2.1° \\
  Luna & = & Neptuno & Conjunción & 2.8° \\
  Luna & ✶ & Plutón & Sextil & 4.1° \\
  Luna & □ & Nodo Norte & Cuadratura & 5.5° \\
  Luna & □ & Nodo Sur & Cuadratura & 5.5° \\
  \bottomrule
\end{tabular}
\end{center}
...
\vspace{0.8cm}
\begin{center}
\includegraphics[width=0.80\textwidth]{C:/Users/Izas/claude/astrología/pruebas/Amaya_Ascunce_Luna_C4_C6_rueda.png}
\end{center}
...
Existe facilidad para mover emocionalmente lo que te pasa.

Cuando algo te afecta, normalmente encuentras alguna forma de actuar, descargar o hacer algo útil con esa energía. La acción puede ayudarte a no quedarte demasiado tiempo dentro de la activación.

Mover el cuerpo o tomar iniciativa regula mucho tu estado interno.

Absorbes muchísimo emocionalmente del entorno.

Muchas veces te afecta el estado emocional de otras personas sin que seas plenamente consciente de ello. Sin límites emocionales claros, puedes terminar llevando dentro cargas que no eran tuyas.

La regulación necesita silencio, vaciado y una revisión constante de qué pertenece realmente a tu mundo interno.

Existe una vía de profundidad emocional que puede convertirse en recurso.

Cuando te permites mirar lo que ocurre por debajo de la superficie, recuperas fuerza interna. Tu mundo emocional se regula mejor cuando no tiene que quedarse en lo superficial.

La honestidad profunda contigo puede devolverte centro.
...
El regente de la Casa 4 es Plutón, en Libra y en Casa 3. La base interna tiende a organizarse desde la comunicación y el entorno cercano, con la cualidad mental y relacional de Libra.

Tu sensación de hogar nunca ha sido completamente estable.

Puede haber habido cambios, rupturas o dinámicas imprevisibles dentro del entorno de origen.

Existe una parte de ti que necesita libertad y movimiento incluso dentro de lo íntimo.

Y al mismo tiempo, otra parte necesita profundamente sentir suelo y estabilidad.

Cuando una relación o un espacio empiezan a sentirse demasiado cerrados, puede aparecer necesidad de distancia o escape.

Te resulta difícil sostener estabilidad cuando sientes que pierdes libertad.
...
El regente de la Casa 6 es Saturno, en Virgo y en Casa 2. La regulación cotidiana tiende a organizarse desde los recursos y el valor propio, con la cualidad concreta y sostenida de Virgo.

Necesitas cierto bienestar real dentro de la vida cotidiana para sentirte bien físicamente.

No suele regularte vivir únicamente desde la obligación.

La belleza, el disfrute simple, la armonía o sentir comodidad en el entorno tienen muchísimo impacto sobre tu energía.

Cuando el día a día se vuelve demasiado frío, mecánico o puramente productivo, el cuerpo empieza a vaciarse.

Necesitas que exista algo agradable, humano y habitable dentro de la rutina.
...
Además, Urano en la Casa 4 influye directamente en tu sensación de base interna.
...
Los aspectos de tensión con el Nodo Norte y el Nodo Sur hacen que el mundo emocional tenga menos margen en ciertos momentos.
...
Al mismo tiempo, los aspectos de apoyo con Marte, Neptuno y Plutón ofrecen recursos reales.
...
Los aspectos de tensión con el Nodo Norte y el Nodo Sur hacen que ese margen sea más estrecho.
...
Los aspectos de apoyo con Marte y Neptuno funcionan como recursos cuando consigues recuperar un primer punto de estabilidad.
